          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              <ul className="list-disc list-inside space-y-2 text-sm text-slate-600 pl-4">
                ...
                <li>Los íconos <CheckCircle2 className="inline h-4 w-4 text-green-500"/>, <XCircle className="inline h-4 w-4 text-red-500"/> y <Minus className="inline h-4 w-4 text-gray-400"/> te dan una vista rápida.</li>
                <li>Para atributos como "Ambiente", verás insignias con las características principales.</li>
                <li>Si ves <Info className="inline h-4 w-4 text-blue-500"/> <strong>"Ver detalles"</strong>, haz clic para ver información compleja.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
